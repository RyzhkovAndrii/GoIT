...
public class UseCache {
    ...
    private static final String BOOK_NAME_1984 = "1984";
    private static final String SHANTARAM = "SHANTARAM";
    private static final String SHERLOK = "sherlok";

    private static LinkedHashMap<String, String> biggestWordCache = new CacheLinkedHashMap<>(2, false);
